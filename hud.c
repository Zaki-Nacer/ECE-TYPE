...
void nettoyer_ressources_hud(GameState *gameState) {
    ...
    if (gameState->barre_progression_pleine) { destroy_bitmap(gameState->barre_progression_pleine); gameState->barre_progression_pleine = NULL; }
    printf("Ressources HUD détruites.\n"); fflush(stdout);
}
